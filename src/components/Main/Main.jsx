...
const Main = () => {
  const prompt1 = "Who are British Columbia Lottery Corporation";
  const prompt2 = "Key Features of British Columbia Lottery Corporation";
  const prompt3 = "How British Columbia Lottery Corporation ensures safe gambling?";
  const prompt4 = "Goals of British Columbia Lottery Corporation";
